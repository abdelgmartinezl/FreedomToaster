...
class Guardar1(clutter.Texture):
	...
	def clicked(self, stage, event):
		os.system("python '/home/potty/Toquin/src/ficha_libro.py' libro_3")
...
class Guardar2(clutter.Texture):
	...
	def clicked(self, stage, event):
		os.system("python '/home/potty/Toquin/src/ficha_libro.py' libro_4")
...
fondo = clutter.Texture(filename="/home/potty/Toquin/img/libro2.jpg")
