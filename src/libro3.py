...
class Guardar1(clutter.Texture):
	...
	def clicked(self, stage, event):
		os.system("python '/home/potty/Toquin/src/ficha_libro.py' libro_5")
...
class Guardar2(clutter.Texture):
	...
	def clicked(self, stage, event):
		os.system("python '/home/potty/Toquin/src/ficha_libro.py' libro_6")
...
fondo = clutter.Texture(filename="/home/potty/Toquin/img/libro3.jpg")
